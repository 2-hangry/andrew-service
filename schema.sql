...
LOAD DATA LOCAL INFILE './dbDataGenAndSeeding/csvFiles/users.csv' INTO TABLE users
FIELDS TERMINATED BY ','
IGNORE 1 LINES
(userName,profileImageUrl,friendsCount,reviewsCount,eliteStatus)
SET id = NULL;

LOAD DATA LOCAL INFILE './dbDataGenAndSeeding/csvFiles/businesses.csv' INTO TABLE businesses
FIELDS TERMINATED BY ','
IGNORE 1 LINES
(businessName)
SET id = NULL;

LOAD DATA LOCAL INFILE './dbDataGenAndSeeding/csvFiles/photos.csv' INTO TABLE photos
FIELDS TERMINATED BY ','
IGNORE 1 LINES
